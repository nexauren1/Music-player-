...
public final class MainActivity extends AppCompatActivity {
    ...
    private void showSettings() {
        ...
        clickableRow(list, "Sobre o Nexauren Music Player", "Versão 1.1.0", "ⓘ", () -> showAbout("Nexauren Music Player", "Versão 1.1.0 • player local, efeitos, favoritos, fila e pesquisa."));
    }
