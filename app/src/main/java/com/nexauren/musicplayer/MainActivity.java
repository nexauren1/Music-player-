...
public final class MainActivity extends AppCompatActivity {
    ...
    private void showSettings() {
        ...
        clickableRow(list, "Sobre o Nexauren Music Player", "Versão 0.3.0", "ⓘ", () -> showAbout("Nexauren Music Player", "Versão 1.0.0 • player local, efeitos, favoritos, fila e pesquisa."));
    }
